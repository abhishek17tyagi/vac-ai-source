...
from vacAI.shared_libraries import constants

SAMPLE_SCENARIO_PATH = os.getenv(
    "VacAI_SCENARIO", "vacAI/profiles/itinerary_empty_enhanced_default.json"
)
...
def _load_precreated_itinerary(callback_context: CallbackContext):
    ...
    Set this as a callback as before_agent_call of the vacAI.
